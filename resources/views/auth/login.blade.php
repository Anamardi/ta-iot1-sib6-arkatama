            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-6 text-center">
                    <div class="sign-in-detail text-white"
                        style="background: url(images/login/3.png) no-repeat 0 0; background-size: cover;">
                        <a class="sign-in-logo mb-5" href="#"><img src="images/login/Anaisme2.png" class="img-fluid"
                                alt="logo"></a>
                        <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true"
                            ...
                            <div class="item">
                                <img src="images/login/8.png" class="img-fluid mb-4" alt="logo">
                                <h4 class="mb-1 text-white">Selamat Datang</h4>
                                <p>Di Website Sistem Pemantauan Lingkungan Berbasis IoT dengan Notifikasi dan Kontrol Jarak Jauh</p>
                            </div>
                            <div class="item">
                                <img src="images/login/8.png" class="img-fluid mb-4" alt="logo">
                                <h4 class="mb-1 text-white">Selamat Datang</h4>
